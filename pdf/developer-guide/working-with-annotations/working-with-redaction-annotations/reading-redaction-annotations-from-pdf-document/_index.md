...
We have used [PdfWithAnnotations.pdf](/pdf/reading-redaction-annotations-from-pdf-document/PdfWithAnnotations.pdf) for the example below. In this example we are demonstration **/pdf/{name}/annotations/highlight/{redaction}** resource to read Annotation Information by ID. You can use **/pdf/{name}/annotations/redaction**or **/pdf/{name}/annotations/redaction** to get the desired annotation identifier. The above resources return the following Highlight Annotation information for the document
